"""
PsiNN_laplace.py - Psi-NN Architecture for Laplace Equation

This file is taken from the Psi-NN reference implementation:
Source: https://github.com/ZitiLiu/Psi-NN

Original Authors: Liu, Z., Liu, Y., Yan, X. et al.
Publication: Automatic network structure discovery of physics informed neural
             networks via knowledge distillation.
             Nat Commun 16, 9558 (2025).
             https://doi.org/10.1038/s41467-025-64624-3

Citation: Please cite the original paper if you use this code.

This model implements a specialized neural network architecture for solving
the Laplace equation with discovered symmetry properties (even function).
